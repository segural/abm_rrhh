...
router.get("/chiefs", authMiddleware, sysconfigController.chieflist);
...
router.post("/newchief", authMiddleware, sysconfigController.chiefStore);
...
router.delete("/chiefs/:id", sysconfigController.chiefDestroy);
